...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "LinuCC"
    user-mail-address "linucc@linu.cc")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/pascalernst/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/pascalernst/bin" "/profile/bin" "/Users/pascalernst/.npm-packages/bin" "/Users/pascalernst/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
